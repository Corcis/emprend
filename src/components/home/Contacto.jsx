                        ...
                        <div className="container contenido_contacto">
                            ...
                            <div className="mb-3 row contenido_input">
                                ...
                                <div className="col-sm-11">
                                    <input type="text" className="form-control align-self-center" name="nombre" placeholder="Nombre" required/>
                                </div>
                            </div>
                            <div className="mb-3 row  contenido_input">
                                <label className="col-sm-1">
                                ...
                                <div className="col-sm-11">
                                    <input type="email" className="form-control align-self-center" name="correo" placeholder="Correo Electrónico" required/>
                                </div>
                            </div>
                            <div className="mb-3 row  contenido_input">
                                <label className="col-sm-1">
                                ...
                                <div className="col-sm-11">
                                    <input type="tel" className="form-control align-self-center" name="telefono" placeholder="Teléfono" required/>
                                </div>
                            </div>
                            <div className="mb-3 row  contenido_input">
                                <label className="col-sm-1">
                                ...
                                <div className="col-sm-11">
                                    <input type="date" className="form-control align-self-center" name="fecha" placeholder="Elegir fecha" required/>
                                </div>
                            </div>
                            <div className="mb-3 row  contenido_input">
                                <label className="col-sm-1">
                                ...
                                <div className="col-sm-11">
                                    <textarea className="form-control align-self-center" name="comentario" placeholder="Mensaje" required></textarea>
                                </div>
                            </div>
                            <div className="mb-3 row contenido_input">
                                <div className="col-sm-12 d-flex justify-content-end">
                                    <button type="submit" className="btn btn-lg btn-emprend nosotros_btn"><FontAwesomeIcon icon={faArrowRight} /> Enviar</button>
                                </div>
                            </div>
                        </div>
                    </form>
